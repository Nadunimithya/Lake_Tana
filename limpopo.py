...
def create_sunburst():
    ...
    fig.update_layout(
    margin=dict(t=0, l=0, r=0, b=0),  # Reduce top margin to minimum
    hoverlabel=dict(font_size=32, font_family="Arial, sans-serif"),
    # uniformtext=dict(minsize=12, mode='show')  # Ensures text doesn't create extra padding
)
